...
public class Frm_Principal extends javax.swing.JFrame {
    ...
    public Frm_Principal(String usuarioLogeado) {
        ...
        if (!this.usuarioLogeado.equals("admin")) {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 500, 230, 40));
        ...
        jPanel1.add(jButton7, new org.netbeans.lib.awtextra.AbsoluteConstraints(1150, 20, -1, -1));
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        Frm_Login sesion = new Frm_Login();
